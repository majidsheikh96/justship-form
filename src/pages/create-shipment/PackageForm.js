                                            ...
                                            <div className="grid grid-cols-[auto_30px] items-center mb-4 md:mb-0">
                                                <div className="flex items-center justify-between">
                                                    <input
                                                        ...
                                                        min={1}
                                                        inputMode="decimal"
                                                        className={`form-input w-[65px] md:w-[55px] h-[40px] text-center text-dark-purple font-semibold border-error-red shadow-border-error ${(errors.packages) && (errors.packages[index]?.box.length) ? 'ring-1  ring-rose-500' : ""}`}
                                                    ...
                                                    <input
                                                        type="number"
                                                        inputMode="decimal"
                                                        className={`form-input rounded-xl w-[65px] md:w-[55px] h-[40px] text-center text-dark-purple font-semibold border-transparent ${(errors.packages) && (errors.packages[index]?.box.width) ? 'ring-1 ring-rose-500' : ""}`}
                                        ...
                                        <div className="flex flex-col mb-6 md:mb-0 ">
                                            ...
                                            <div className="grid grid-cols-[auto_30px] items-center mb-4 md:mb-0">
                                                <input
                                                    type="number"
                                                    inputMode="decimal"
                                                    className={`form-input rounded-xl w-[65px] md:w-[55px] h-[40px] text-center text-dark-purple font-semibold border-transparent ${(errors.packages) && (errors.packages[index]?.box.weight) ? 'ring-1 ring-rose-500' : ""}`}
